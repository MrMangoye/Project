...
router.get('/families/:id/finance', auth, async (req, res) => {
  try {
    console.log('Getting finance data for family:', req.params.id);
...
router.post('/goals', auth, async (req, res) => {
  try {
    console.log('Creating financial goal:', req.body);
...
router.put('/goals/:id/progress', auth, async (req, res) => {
  try {
    console.log('Updating goal progress:', req.params.id);
...
router.post('/shared-expenses', auth, async (req, res) => {
  try {
    console.log('Creating shared expense:', req.body);
...
router.put('/shared-expenses/:id/pay', auth, async (req, res) => {
  try {
    console.log('Updating shared expense payment:', req.params.id);
...
router.get('/families/:id/analytics/monthly', auth, async (req, res) => {
  try {
    console.log('Getting monthly analytics for family:', req.params.id);
